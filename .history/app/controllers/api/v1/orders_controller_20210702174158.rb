class Api::V1::OrdersController < Api::V1::BaseController
    ...
    class OrderEntryError < OrderingErrors
    ...
    class InvalidCustomerError < OrderingErrors
        def message
            "Invalid Customer"
        end
    end
    ...
    class InvalidMerchantError < OrderingErrors
        def message
            "Invalid Merchant"
        end
    end
     ...
     def create
        ...
        begin
            ...
            # byebug
            if !@order.save
                raise OrderError.new(@order.errors.full_messages) #message: @order.errors.full_messages.join("/n") }
            end
