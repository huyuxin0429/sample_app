class Drone < ApplicationRecord
  ...
  def deliver(order)
    ...
    route_array = GraphModules.path_address(nearestStation2me.provided_id, nearestStation2merchant.provided_id)
    route_array << merchant_addresss
    route_array << GraphModules.path_address(nearestStation2merchant.provided_id, nearestStation2cust.provided_id)
    route_array <<
