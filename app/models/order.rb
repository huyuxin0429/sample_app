class Order < ApplicationRecord
    ...
    def progress
      ...
      ActionCable.server.broadcast "order_channel_user_#{customer_id}", output_hash.to_json

      ActionCable.server.broadcast "order_channel_user_#{merchant_id}", output_hash.to_json
        # save!
    end
